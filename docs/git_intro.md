...
```bash
git commit -m "Complete task05: solve quadratic equation"
```
...
4. **Stage and commit your changes**
   ...
   git commit -m "Complete task 05a: solve quadratic equation"
   ```
...
- Examples:
  - ✅ Good: "Implement Newton method for root finding"
